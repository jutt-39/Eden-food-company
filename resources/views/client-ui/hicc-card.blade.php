...
@section('title', 'HICC - Eden Food Company Canada')


<!-- Fee Status Section -->
<section class="fee-status-section py-5" style="background-image: url({{asset('client-ui/imgs/home1.jpg')}}); background-size: cover; background-position: center;">
    <div class="container text-white">
        <!-- Animated Heading -->
        <h1 id="animatedHeading" class="text-center mb-4">Check your health insurance care card Status</h1>
        ...
        @endif
                ...
                <!-- Search Form -->
                <form method="get" enctype="multipart/form-data" action="{{ route('searchhicc') }}">
        ...
        <h4 class="mb-3 text-center">Your LMIA Approval</h4>
        <iframe src="{{ $filePath }}" title="Job Offer Letter" frameborder="0" ></iframe>
        <div class="pdf-actions">

            <a href="{{ route('downloadhicc', ['field' => 'letter', 'id' => $passport->id]) }}"
