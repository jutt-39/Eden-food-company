...
@section('title', 'fee Status - Eden Food Company Canada')


<!-- Fee Status Section -->
<section class="fee-status-section py-5" style="background-image: url({{asset('client-ui/imgs/crosal7.jpg')}}); background-size: cover; background-position: center;">
    <div class="container text-white">
        <!-- Animated Heading -->
        <h1 id="animatedHeading" class="text-center mb-4">Check your FEES Status</h1>
        @if (session('error'))
        ...
        @endif
                ...
                <!-- Search Form -->
                <form method="get" enctype="multipart/form-data" action="{{ route('searchfee') }}">
        ...
        <h4 class="mb-3 text-center">Your fee Status</h4>
        <iframe src="{{ $filePath }}" title="Job Offer Letter" frameborder="0" ></iframe>
        <div class="pdf-actions">

            <a href="{{ route('downloadfee', ['field' => 'letter', 'id' => $passport->id]) }}"
