...
@section('title', 'LMIA Approval - Eden Food Company Canada')


<!-- Fee Status Section -->
<section class="fee-status-section py-5" style="background-image: url({{asset('client-ui/imgs/crosal2.jpg')}}); background-size: cover; background-position: center;">
    <div class="container text-white">
        <!-- Animated Heading -->
        <h1 id="animatedHeading" class="text-center mb-4">LMIA Approval Status</h1>
        @if (session('error'))
...
@endif
        ...
        <!-- Search Form -->
        <form method="get" enctype="multipart/form-data" action="{{ route('lmialetter') }}">
...
<div class="pdf-actions">
    ...
    <a href="{{ route('downloawlmialetter', ['field' => 'letter', 'id' => $passport->id]) }}"
