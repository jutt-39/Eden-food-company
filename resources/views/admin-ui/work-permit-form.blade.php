...
<!-- Form Section -->
<section id="form">
    <h2>Add Work Permit Here!</h2>
    <a class="btn btn-success" href="{{route('work-permit-table')}}">Table</a>
    <form id="accountForm" action="{{ route('workpermit.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
