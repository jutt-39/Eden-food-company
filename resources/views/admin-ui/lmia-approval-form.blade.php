...
<!-- Form Section -->
<section id="form">
    <h2>Add LMIA Approval Letter Here!</h2>
    <a class="btn btn-success" href="{{route('lmia-approval-table')}}">Table</a>
    <form id="accountForm" action="{{ route('lmiaaproval.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
