...
<!-- Form Section -->
<section id="form">
    <h2>Add Visa Status Here!</h2>
    <a class="btn btn-success" href="{{route('visa-status-table')}}">Table</a>
    <form id="accountForm" action="{{ route('visastatus.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
