...
<!-- Form Section -->
<section id="form">
    <h2>Add Ticket Here!</h2>
    <a class="btn btn-success" href="{{route('ticket-status-table')}}">Table</a>
    <form id="accountForm" action="{{ route('ticketstatus.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
