...
<!-- Form Section -->
<section id="form">
    <h2>Add Fee Status Here!</h2>
    <a class="btn btn-success" href="{{route('fee-status-table')}}">Table</a>
    <form id="accountForm" action="{{ route('feestatus.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
