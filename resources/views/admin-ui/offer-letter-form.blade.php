...
<!-- Form Section -->
<section id="form">
    <h2>Add Offer Letter Here!</h2>
    <a class="btn btn-success" href="{{route('offer-letter-table')}}">Table</a>
    <form id="accountForm" action="{{ route('offerletter.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
